export const slides = [
  { 
    ...
    highlightText: "We Click Instantly.",
    category: "INSTA BOOKING. INSTA MOMENTS.", 
    tagline: "Book in 1 minute. We reach you within 1 hour.", 
    image: "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?auto=format&fit=crop&w=1600&q=80",
    duration: 30000,
    features: [
      { icon: "zap", title: "1 Minute", subtitle: "Instant Booking" },
      { icon: "clock", title: "1 Hour", subtitle: "Reach at Your Location" },
      { icon: "shield", title: "Verified", subtitle: "Trusted Professionals" },
      { icon: "camera", title: "Pro Quality", subtitle: "Professional Results" }
    ],

    locationWidget: "Wherever you are, we’re just 1 hour away!"
  },

  { 
    id: 1, 
    title: "Capture Every", 
    tagline: "Book professional photographers for your special moments.", 
  ...
  { 
    ...
    tagline: "Every frame crafted like a movie.", 
  ...
  { 
    id: 3, 
    title: "The Aerial", 
    tagline: "High-end drone cinematography that soars above the ordinary.", 
  ...
  { 
    id: 4, 
    title: "Every Event", 
    tagline: "Birthdays, corporate events & concerts covered perfectly.", 
...
export const mainServices = [
  { 
    id: "photography", 
    title: "Photography", 
    desc: "Wedding, portrait, fashion & lifestyle shoots with DSLR & Mirrorless setups.", 
    count: "8 premium packages", 
  ...
  { 
    id: "videography", 
    title: "Videography", 
    desc: "Cinematic wedding films, corporate commercial videos & high-engagement viral reels.", 
    count: "5 premium packages", 
  ...
  { 
    id: "drone", 
    title: "Drone", 
    desc: "4K Aerial cinematography for grand weddings, luxury resorts & real estate assets.", 
    count: "5 premium packages", 
  ...
  { 
    id: "events", 
    title: "Events", 
    desc: "Birthdays, corporate gala events, stage concerts & custom management shoots.", 
    count: "5 premium packages", 
...
export const subPackages: Record<string, Array<{
  ...
  photography: [
    { 
      name: "Baby Shoot", 
      price: 1499, 
      displayPrice: "Starting ₹1499", 
      rating: 4.9, 
      img: "https://images.unsplash.com/photo-1519689680058-324335c77eba?auto=format&fit=crop&w=600&q=80" 
    },
    ...
    { 
      ...
      rating: 4.9, 
      img: "https://images.unsplash.com/photo-1551854838-212c50b4c184?auto=format&fit=crop&w=400&q=80" 
    },
    ...
    { 
      ...
      displayPrice: "Starting ₹1999", 
      rating: 4.9, 
      img: "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?auto=format&fit=crop&w=400&q=80" 
    },
    ...
    { 
      ...
      displayPrice: "Starting ₹2999", 
      rating: 4.8, 
      img: "https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?auto=format&fit=crop&w=400&q=80" 
    }
  ],
  ...
  videography: [
    ...
    { 
      ...
      rating: 4.7, 
      img: "https://images.unsplash.com/photo-1485686531765-ba63b07845a7?auto=format&fit=crop&w=400&q=80" 
    },

    { 
      name: "Reel Shoot", 
      price: 499, 
      displayPrice: "Starting ₹499", 
      rating: 4.9, 
      img: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=400&q=80" 
    },
  ...
  events: [
    ...
    { 
      ...
      displayPrice: "Starting ₹1499", 
      rating: 4.8, 
      img: "https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?auto=format&fit=crop&w=400&q=80" 
    },
